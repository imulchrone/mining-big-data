...
# python MovieSimilarities.py -r emr --items=ml-100k/u.item ml-100k/u.data --conf-path mrjob.conf

# To run on 4 EMR nodes (master node created by default):
# python MovieSimilarities.py -r emr --num-core-instances=3 --items=ml-100k/u.item ml-100k/u.data --conf-path mrjob.conf
